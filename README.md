...
Note that you will have to write the file directory to the powershell program in order for it to run properly (don't forget to use quotation marks if one of the folders in the directory path has a space in it).
